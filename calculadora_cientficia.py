...
def calcular():
    ...
    modulos = ['math.tan','math.sin','math.cos','math.sqrt','math.log','math.e','math.pow','math.pi']
...
#configuração do frame cientifico
